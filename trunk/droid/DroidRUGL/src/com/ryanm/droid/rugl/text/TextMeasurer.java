...
public class TextMeasurer
{
	 ...
	 *           The text to measure
	 * @param f
	 *           The distance from the start of the text to query
	 ...
	 *           The text to measure
	 * @param f
	 *           The distance from the origin of the starting character
	 * @param startIndex
	 *           The distance from the starting character. Negative
