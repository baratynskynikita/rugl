...
public class SerialUtils
{
	 ...
	 */
	public static byte[] readByteArray( DataSource buffer )
	{
	 ...
	 * @param tuple
	 *           The tuple to store the read values into, or null to
	 ...
	 *           The buffer to read from
	 * @param tuple
	 *           The {@link Vector2f} to store the read values into, or
