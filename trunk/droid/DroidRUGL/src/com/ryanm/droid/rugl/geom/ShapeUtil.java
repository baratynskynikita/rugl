...
public class ShapeUtil
{
	...
	public static Shape chipIcon( int legs, float legLength, float legwidth, float sep )
	{
		...
		ShapeWelder<Shape> b = new ShapeWelder<Shape>();
			...
			float arrowlength, float thickness )
	{
		...
		short[] tris =
				new short[] { 0, 2, 1, 0, 7, 2, 0, 8, 7, 7, 6, 2, 2, 6, 3, 6, 4, 3, 6, 5, 4 };
			...
			float z )
	{
		...
		return new Shape( ShapeUtil.extract( verts ), tris );
	}
			...
			float maxSegment, float z )
	{
		...
		return new Shape( ShapeUtil.extract( verts ), indices );
	}
	...
	public static Shape cross( float width )
	{
		...
		float[] verts =
				new float[] { n, 0, n, n, 0, n, 0, f, n, f, n, 1, f, 1, f, f, 1, f, 1, n, f,
						n, f, 0 };
		short[] tris =
				new short[] { 1, 3, 2, 1, 4, 3, 4, 6, 5, 4, 7, 6, 7, 9, 8, 7, 10, 9, 10, 0,
						11, 10, 1, 0, 1, 7, 4, 1, 10, 7 };
	...
	public static Shape arrow( float bx, float by, float tx, float ty, float cx, float cy )
	{
		...
		short[] tris = new short[] { 1, 3, 2, 1, 5, 3, 5, 4, 3, 0, 5, 1, 0, 6, 5 };
	...
	public static Shape filledQuad( float px, float py, float qx, float qy, float z )
	{
		...
		return new Shape( ShapeUtil.extract( verts ), makeQuads( 4, 0, null, 0 ) );
	}
	 ...
	 */
	public static Shape triangle( float ax, float ay, float bx, float by, float cx,
			float cy )
	{
		float[] v = new float[] { ax, ay, 0, bx, by, 0, cx, cy, 0 };
		short[] t = new short[] { 0, 1, 2 };
	...
	public static Shape outline( float width, float pos, float... vin )
	{
		...
		short[] tris = new short[ 3 * vin.length ];
		int ti = 0;
	...
	public static Shape line( float width, float... vin )
	{
		...
		short[] tris = new short[ 3 * ( vin.length - 2 ) ];
		int ti = 0;
	 ...
	 */
	public static short[] makeQuads( int vertexCount, int startVertex, short[] dest,
			int start )
	{
		if( dest == null )
		{
			dest = new short[ 6 * ( vertexCount / 4 ) ];
			start = 0;
		}
		...
		{
			dest[ index++ ] = ( short ) i;
			dest[ index++ ] = ( short ) ( i + 3 );
			dest[ index++ ] = ( short ) ( i + 1 );
			dest[ index++ ] = ( short ) i;
			dest[ index++ ] = ( short ) ( i + 2 );
			dest[ index++ ] = ( short ) ( i + 3 );
		}
