...
public class Frustum
{
	...
	public void extractFromOGL()
	{
		...
		double t =
				sqrt( frustum[ 0 ][ 0 ] * frustum[ 0 ][ 0 ] + frustum[ 0 ][ 1 ]
		...
		/* Normalize the result */
		t =
				sqrt( frustum[ 1 ][ 0 ] * frustum[ 1 ][ 0 ] + frustum[ 1 ][ 1 ]
		...
		/* Normalize the result */
		t =
				sqrt( frustum[ 2 ][ 0 ] * frustum[ 2 ][ 0 ] + frustum[ 2 ][ 1 ]
		...
		/* Normalize the result */
		t =
				sqrt( frustum[ 4 ][ 0 ] * frustum[ 4 ][ 0 ] + frustum[ 4 ][ 1 ]
		...
		/* Normalize the result */
		t =
				sqrt( frustum[ 5 ][ 0 ] * frustum[ 5 ][ 0 ] + frustum[ 5 ][ 1 ]
